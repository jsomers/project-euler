...
Important insights: (1) the marker matrix, (2) the "route-feeding" function, (3) the pair-building loop, (4) initializing the routes to a large number, (5) the route-finder.
"""
...
# Function to reverse engineer the actual route (instead of the sum). Useful for debugging/curiosity.
